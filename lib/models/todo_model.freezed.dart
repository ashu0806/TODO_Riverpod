...
abstract class $TodoModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String desc, bool isCompleted});
}
...
class _$TodoModelImpl implements _TodoModel {
  const _$TodoModelImpl(
      {required this.id, required this.desc, required this.isCompleted});
  ...
  @override
  String toString() {
    return 'TodoModel(id: $id, desc: $desc, isCompleted: $isCompleted)';
  }
